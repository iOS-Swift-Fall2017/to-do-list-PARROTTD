...
//  To Do List
//
//  Created by Duncan Parrott on 9/22/17.
...
class ViewController: UIViewController {
    ...
    //var toDoNotesArray = ["learn swift from prof. gallaugher", "make some apps that are really cool", "make it a better place"]
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int { return toDoArray.count
}
